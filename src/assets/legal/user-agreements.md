## CoCliCo Platform (beta) User Agreement Deltares
...
- 1.1	By presenting this Website and providing Data Products that can be accessed online as well as directly downloaded, Deltares intends to provide users with the opportunity to evaluate and study Coastal climate change impact.
- 1.2 All data provided through our Website and Data Products are purely indicative data that are only validated to a very limited extent, and User hereby agrees not to use the Website and the Data Products for any decision-making or operational purposes.
...
- 2.2 LISCoAsT Storm Surge Level Data
  - 2.2.1	The purpose of the LISCoAsT Storm Surge Level data is to: (i) Develop dynamic scenarios of catastrophic coastal hazards (e.g., storm surges, sea-level rise) in view of climate change; (ii) Develop scenarios of exposure and vulnerability in coastal areas; (iii) Carry out a bottom-up, highly disaggregated assessment of climate impacts on coastal areas in Europe and worldwide in view of global warming.
  - 2.2.2	The LISCoAsT Storm Surge Level Data Products are purely indicative data. User hereby agrees NOT to use the LISCoAsT Storm Surge Level Data Products for any decision-making or operational purposes.  
...
- 6.2	User acknowledges and agrees to the warranty provisions specified below that are applicable to the type of dataset for which User accesses or downloads Data Products.
  - 6.2.1	LISCoAsT Storm Surge Level Data Products: Deltares does not guarantee, or imply in any way, that the LISCoAsT Storm Surge Level Data Products correspond to actual surface water changes at User’s selected area(s) and timeframe(s).
