  ...
  >
    <v-card class="d-flex flex-column pa-3" style="max-height: 100%;overflow:hidden">
      <div class="scrollbar">
        ...
        <div
          class="markdown"
          v-html="markedText(CookieAgreements)"
          :anchor-attributes="{ target: '_blank', rel: 'noopener' }"
        />
      </div>
      <v-card-actions>
...
<script>
import UserAgreements from '@/assets/legal/user-agreements.md'
import CookieAgreements from '@/assets/legal/cookie-agreements.md'
